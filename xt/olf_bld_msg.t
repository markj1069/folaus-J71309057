...
./olf_bld_msg_t.exe 7000 $EX_OK "Return Code set to EX_OK" >$TMPFILE
RC=$?
...
./olf_bld_msg_t.exe 7004 $EX_WARNING "Return Code set to EX_WARNING" >$TMPFILE
RC=$?
...
./olf_bld_msg_t.exe 7008 $EX_ERROR "Return Code set to EX_ERROR" >$TMPFILE
RC=$?
...
./olf_bld_msg_t.exe 7012 $EX_SEVERE "Return Code set to EX_SEVERE" >$TMPFILE
RC=$?
...
./olf_bld_msg_t.exe 7016 $EX_FATAL "Return Code set to EX_FATAL" >$TMPFILE
RC=$?
...
./olf_bld_msg_t.exe 7076 $EX_PROTOCOL "Return Code set to EX_PROTOCOL" >$TMPFILE
RC=$?
...
./olf_bld_msg_t.exe 7064 999 "Return Code set to EX_USAGE" >$TMPFILE
RC=$?
is $RC $EX_FATAL "Return Code set to EX_FATAL. line: $LINENO"
...
./olf_bld_msg_t.exe 7064 -1 "Return Code set to EX_FATAL" >$TMPFILE
RC=$?
is $RC $EX_FATAL "Return Code set to EX_FATAL. line: $LINENO"
