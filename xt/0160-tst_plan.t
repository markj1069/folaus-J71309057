...
xt/0161-tst_plan.exe 1 >$OUTFILE 2>$ERRFILE
RC=$?
...
xt/0161-tst_plan.exe 10 >$OUTFILE 2>$ERRFILE
RC=$?
...
xt/0161-tst_plan.exe 0 >$OUTFILE 2>$ERRFILE
RC=$?
...
MSG="OLS7002F Number of plan tests less than one. Fatal Error."
FILE=$( cat $ERRFILE )
